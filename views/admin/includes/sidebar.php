<div class="main-sidebar sidebar-style-2">
    <aside id="sidebar-wrapper">
        <div class="sidebar-brand">
            <a href="index.php">Cater Craft</a>
        </div>
        ...
        <ul class="sidebar-menu">
            ...
            <li class="active"><a class="nav-link" href="../../views/admin/admin_dashboard.php"><i class="fas fa-tachometer-alt"></i> <span>Dashboard</span></a></li>
