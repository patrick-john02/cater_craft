        ...
        <button class="btn btn-primary mb-3" data-toggle="modal" data-target="#addPackageModal">
          <i class="fas fa-plus"></i> Add Menu
              ...
              <div class="col-12 col-sm-6 col-md-6 col-lg-3">
                <article class="article">
                  <div class="article-header">
                    <div class="article-image" data-background="../../public/uploads/4.jpg">
                    </div>
              ...
              <div class="col-12 col-sm-6 col-md-6 col-lg-3">
                <article class="article">
                  <div class="article-header">
                    <div class="article-image" data-background="../../public/uploads/1.jpg">
                    </div>
                    <div class="article-title">
             ...
             <!-- Dish 3 -->
              <div class="col-12 col-sm-6 col-md-6 col-lg-3">
                <article class="article">
                  <div class="article-header">
                    <div class="article-image" data-background="../../public/uploads/2.jpg">
                    </div>
                    <div class="article-title">
              ...
              <div class="col-12 col-sm-6 col-md-6 col-lg-3">
                <article class="article">
                  <div class="article-header">
                    <div class="article-image" data-background="../../public/uploads/3.jpg">
                    </div>
                    <div class="article-title">
